...
/* compiler */
#define VLC_COMPILER "gcc version 4.4.1 (TDM-2 mingw32) "

/* user who ran configure */
#define VLC_COMPILE_BY "Unsuspected"

/* host which ran configure */
#define VLC_COMPILE_HOST "UNSUSPECTED-PC"
