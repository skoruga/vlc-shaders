...
static const char qt_meta_stringdata_EPGWidget[] = {
    "EPGWidget\0\0itemSelectionChanged(EPGEvent*)\0"
    "level\0setZoom(int)\0pp_epg,i_epg\0"
    "updateEPG(vlc_epg_t**,int)\0"
};

const QMetaObject EPGWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_EPGWidget,
      qt_meta_data_EPGWidget, 0 }
};
...
int EPGWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: itemSelectionChanged((*reinterpret_cast< EPGEvent*(*)>(_a[1]))); break;
        case 1: setZoom((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: updateEPG((*reinterpret_cast< vlc_epg_t**(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 3;
    }
...
// SIGNAL 0
void EPGWidget::itemSelectionChanged(EPGEvent * _t1)
{
