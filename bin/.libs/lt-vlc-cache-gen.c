...
/* ./.libs/lt-vlc-cache-gen.c - temporary wrapper executable for .libs/vlc-cache-gen.exe
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh vlc-cache-gen",
   but could eventually absorb all of the scripts functionality and
   exec .libs/vlc-cache-gen.exe directly.
*/
#ifdef _MSC_VER
...
const char * LIB_PATH_VALUE   = "/home/skoruga/vlc-shaders/vlc/src/.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/usr/win32/lib;/usr/win32/bin;/home/skoruga/vlc-shaders/vlc/src/.libs;/usr/local/lib;/usr/local/bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("  notinst_deplibs=' ../src/libvlc.la /home/skoruga/vlc-shaders/vlc/src/libvlccore.la ../src/libvlccore.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    PATH=\"/home/skoruga/vlc-shaders/vlc/src/.libs:$PATH\"\n", f);
  fputs ("\n", f);
  ...
  fputs ("    PATH=/usr/win32/lib:/usr/win32/bin:/home/skoruga/vlc-shaders/vlc/src/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);
